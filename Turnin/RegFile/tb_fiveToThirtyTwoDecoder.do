...
add wave -noupdate -divider "TB for tb_fiveToThirtyTwoDecoder"
add wave -noupdate -divider "N=32"

# Create a section for inputs
add wave -noupdate -divider {Inputs}
add wave -noupdate -label Input /tb_fiveToThirtyTwoDecoder/s_IN
add wave -noupdate -label Enable /tb_fiveToThirtyTwoDecoder/s_EN


# Create a section for outputs
add wave -noupdate -divider {Output}
add wave -noupdate -label DataOut /tb_fiveToThirtyTwoDecoder/s_OUT

# Create a sections that houses all internal signals
add wave -noupdate -divider {others}
add wave -noupdate /tb_fiveToThirtyTwoDecoder/DUT0/*
